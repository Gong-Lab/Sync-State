function [cells_pDA,n_cells_pDA] = getPutativeDA_NoCit3(spikeTimes, pumpOn, lickT)
...
cells_pDA=find(r_b_mean<=10 & r_b_max<=60  & r_c_mean<=15 & r_c_max<=90);%ids of putative DAN
